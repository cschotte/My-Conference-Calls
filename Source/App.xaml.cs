...
namespace MyConferenceCalls
{
    ...
    {
        /// <summary>
        /// ViewModel for databinding in xaml
        /// </summary>
        ...
        {
            string CurrentCulture = Settings.Read<string>("Language", Thread.CurrentThread.CurrentCulture.Name);
        ...
        public static void ChangeCulture(string cultureName)
        {
            ...
            Settings.Write<string>("Language", cultureName);
        }
        #endregion
        ...
        private void StartPeriodicAgent()
        {
            ...
            {
                if (periodicTask.IsEnabled && periodicTask.IsScheduled) return;
